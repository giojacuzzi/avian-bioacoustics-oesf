...
for (file in files) {
  ...
  # Plot
  p = spectrogram(sound, alim=c(-55,0)) +
    labs(title = 'Normalized Difference Soundscape Index (NDSI)',
         subtitle = paste0('Frequency band limits ', f1_min, '-', f1_max, ' : ', f2_min, '-', f2_max, ' Hz')) +
    annotate('rect', xmin = 0, xmax = 20, ymin = f1_min/1000, ymax = f1_max/1000,
           alpha = .2, color = 'red', fill = 'red') +
    annotate('rect', xmin = 0, xmax = 20, ymin = f2_min/1000, ymax = f2_max/1000,

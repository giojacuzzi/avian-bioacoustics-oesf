...
def get_recording_info(taxonCode):
    ...
    search_url = f'https://search.macaulaylibrary.org/api/v2/search?taxonCode={taxonCode}&mediaType=audio&beginYear={beginYear}&endYear={endYear}&regionCode={regionCode}'

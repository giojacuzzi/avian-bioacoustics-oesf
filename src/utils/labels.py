...
def clean_label(label):
    ...
    consolidated_labels = {
        ...
        "abiotic_other_anthropogenic": ["machinery", "machine", "vehicle", "vehicle backing up noise", "truck reverse sound", "vehicle?","engine","machine banging","vehicle backing up", "car"],

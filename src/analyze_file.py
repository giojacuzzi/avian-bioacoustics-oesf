...
if use_custom_model: # Target (custom) model
    ...
    labels_filepath   = 'src/classification/species_list/species_list_OESF.txt' # Species class list. To use global BirdNET list, replace with path to birdnetlib list, e.g. '/Users/giojacuzzi/repos/avian-bioacoustics-oesf/.venv/lib/python3.10/site-packages/birdnetlib/models/analyzer/BirdNET_GLOBAL_6K_V2.4_Labels.txt'
